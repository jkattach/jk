...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      quote_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_quote_requests_selected_bid"
    ...
    Functions: {
      ...
      bid_notify_context: { Args: { p_request: string }; Returns: Json }
      ...
      get_request_by_token: { Args: { p_token: string }; Returns: Json }
      get_request_for_seller: { Args: { p_request: string }; Returns: Json }
      list_open_requests: {
      ...
      request_is_open: { Args: { p_request: string }; Returns: boolean }
      select_bid_by_token: {
        Args: { p_token: string; p_bid: string }
        Returns: Json
      }
    ...
    Enums: {
      bid_status: "submitted" | "selected" | "not_selected" | "withdrawn"
      notification_status: "queued" | "sent" | "failed"
      request_status: "open" | "closed" | "canceled" | "expired"
      order_status:
        | "purchase_confirmed"
        | "approved"
        | "shipping_scheduled"
